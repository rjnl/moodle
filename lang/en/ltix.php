...
$string['core_ltix:mockplacement'] = 'Mock placement'; // A hack permitting the use of the 'core_ltix:mockplacement' mock placement type during core_ltix behat tests.
$string['core_ltix:mockplacement_description'] = 'Mock placement description'; // A hack permitting the use of the 'core_ltix:mockplacement' mock placement type during core_ltix behat tests.
