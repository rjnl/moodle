...
$string['lti_deeplinking_help'] = 'LTI Deep Linking help.';
$string['lti_deeplinkingurl'] = 'LTI Deep Linking URL';
$string['lti_deeplinkingurl_help'] = 'LTI Deep Linking URL help.';

$string['lti_resourcelinking'] = 'LTI Resource Linking Request';
$string['lti_resourcelinking_help'] = 'LTI Resource Linking help.';
$string['lti_resourcelinkingurl'] = 'LTI Resource Linking URL';
$string['lti_resourcelinkingurl_help'] = 'LTI Resource Linking URL help.';
...
$string['default_usage_help'] = 'If enabled, the placement will be available for use.';
