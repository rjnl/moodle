...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2026020500.01) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2026020500.01);
    }

    if ($oldversion < 2026020500.02) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2026020500.02);
    }

    if ($oldversion < 2026020500.04) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2026020500.04);
    }
