...
abstract class service_base {
    ...
    */
    ...
    /**
     * Default implementation will check for the existence of at least one core_ltix entry for that tool and context.
     *
    ...
    private function check_signature($consumerkey, $secret, $body) {
        ...
        try {
            ...
            \core_ltix\oauth_helper::handle_oauth_body_post($consumerkey, $secret, $body);
        } catch (\Exception $e) {
