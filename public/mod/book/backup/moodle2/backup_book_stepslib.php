...
class backup_book_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $book = new backup_nested_element('book', array('id'), array(
            ...
            'customtitles', 'completionreadpercent', 'timecreated', 'timemodified'));
        ...
        $userview = new backup_nested_element('userview', ['id'], ['chapterid', 'userid', 'timecreated', 'timeviewed']);
        ...
        if ($userinfo) {
            ...
            $userview->annotate_ids('user', 'userid');
        }
