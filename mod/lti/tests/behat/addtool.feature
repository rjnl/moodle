...
Feature: Add tools
  ...
  @javascript
  Scenario: Configure a placement status for a LTI tool
  Given I am on the "Course 1" course page logged in as teacher1
    ...
    And I set the field "Activity chooser" to "1"
    # Test Cancel first
